...
+ Point Load 
 ...
 File                                                  | Contents    
 :-------------                                        | :-------------
 [truss.fcstd](truss.fstd)                             | FreeCAD file with the sketch of the model
...
<img src="refs/virtualwork.png" width="400" title="Virtual Work">
...
<img src="refs/FreeCAD.png" width="400" title="FreeCAD">

### Mesh

The mesh and mesh groups are genereated with the mesh module of salome

<img src="refs/Salome.png" width="400" title="salome">
...
<img src="refs/VerticalDisplacements.png" width="400" title="Deformed shape">

To get the axial forces, first a "ELNO Mesh" filter has to be used so the results of element nodes can 
be visualized.

<img src="refs/AxialForces.png" width="400" title="Axial Forces">
