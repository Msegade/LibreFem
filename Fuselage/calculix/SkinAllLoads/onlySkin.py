...
GroupOfEdges = Mesh_1.CreateEmptyGroup( SMESH.EDGE, 'Group_1' )
nbAdd = GroupOfEdges.AddFrom( Mesh_1.GetMesh() )

Mesh_1.RemoveGroupWithContents(GroupOfEdges)
...
try:
      Mesh_1.ExportUNV( r''+ExportPATH+'mesh.unv')
except:
